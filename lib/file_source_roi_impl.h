...
#ifndef INCLUDED_ROI_FILE_SOURCE_ROI_IMPL_H
#define INCLUDED_ROI_FILE_SOURCE_ROI_IMPL_H
...
namespace gr {
  namespace roi {
    ...
    class file_source_roi_impl : public file_source_roi
    {
     private:
        size_t itemsize;
        FILE *fp;
...
#endif /* INCLUDED_ROI_FILE_SOURCE_ROI_IMPL_H */
